...
| **Entité de données** | **Champs clés**                                                                       |
|-----------------------|---------------------------------------------------------------------------------------|
| VersionBiblique       | code · nom · langue · edition (édition exacte du texte) · licence · source · embarquee · fichier · taille · empreinte SHA-256 — référentiel extensible en données, jamais une liste figée |
| Verset                | id · version_id · livre · chapitre · numero_verset · texte — `livre` est un identifiant **stable pour toutes les versions** (1 à 66 protocanon, 67 à 73 deutérocanoniques : Tobie, Judith, 1 et 2 Maccabées, Sagesse, Siracide, Baruch), jamais l'ordre d'affichage d'une version ; les ajouts grecs d'Esther et de Daniel et la Lettre de Jérémie restent des chapitres de leur livre |
...
- **RG-SEC-06bis — Rôle « utilisateur simple » —** tout utilisateur non rattaché à une église comme fidèle enregistré accède uniquement au module XIII (médiathèque chrétienne) en lecture seule, sans aucun autre droit de consultation ou de saisie, jusqu'à ce qu'il complète une affiliation à une église pour devenir fidèle enregistré. **Lecture biblique sans compte (amendement, 2026-09) —** la lecture de la Bible numérique (module XXIV : versions, livres, chapitres, versets, recherche locale, téléchargement des versions libres de droits) est en outre accessible **sans compte ni authentification**, en lecture seule. C'est la seule exception nommée à l'exigence de session (RG-SEC-01) : aucune autre donnée n'est exposée, et toute fonctionnalité personnelle (notes, favoris, surlignages, historique, plans de lecture) exige un compte. Les textes étant lus localement, aucune table du serveur n'est ouverte au rôle anonyme ; seul le dépôt des fichiers des versions téléchargeables est public en lecture, sans aucun droit d'écriture. Les recueils de cantiques rejoindront cette exception lors de la construction de leur extension.
